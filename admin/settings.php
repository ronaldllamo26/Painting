...
<body>
                ...
                <div class="card p-4 p-md-5 mb-4 shadow-sm">
                    ...
                    <form id="settingsForm">
                        <div class="mb-4">
                            ...
                            <input type="text" name="studio_name" class="form-control form-control-lg bg-light border-0" value="<?php echo htmlspecialchars($settings['studio_name']); ?>">
                        </div>
                        <div class="row g-3">
                        ...
                        <button type="submit" class="btn btn-dark px-5 py-3 shadow-sm w-100">Update Studio Info</button>
                    </form>
                </div>

                <div class="card p-4 p-md-5 mb-4 shadow-sm">
                    <h5 class="fw-bold mb-4"><i class="fas fa-robot me-2 text-primary"></i> AI Configuration</h5>
                    <p class="small text-secondary mb-4">Enter your OpenAI API Key to enable automatic artwork descriptions and smart tagging during uploads.</p>
                    <form id="aiConfigForm">
                        ...
                        <button type="submit" class="btn btn-outline-dark w-100 py-3">Save AI Config</button>
                    </form>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="card p-4 p-md-5 shadow-sm">
                    ...
                    <form id="passwordForm">
                        ...
                        <button type="submit" class="btn btn-outline-dark w-100 py-3">Change Password</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById('settingsForm').onsubmit = async (e) => {
            ...
            const resp = await fetch('../api/update_settings.php', { 
                method: 'POST', 
